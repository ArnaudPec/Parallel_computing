...
int TASK_MODULE_init_TASK_NAME(task_t *, void *aux);




int TASK_MODULE_start_TASK_NAME(task_t *);



int TASK_MODULE_run_TASK_NAME(task_t *);




int TASK_MODULE_kill_TASK_NAME(task_t *);




int TASK_MODULE_destroy_TASK_NAME(task_t *);
# 24 "/home/TDDD56/usr/include/drake.h" 2 3
# 7 "drake-sort.c" 2
# 1 "/home/TDDD56/usr/include/drake/intel-ia.h" 1 3
...
main(size_t argc, char **argv)
{
 ...
 void* (drake_function_merge)(size_t id, task_status_t state); void (drake_schedule_init_merge)(drake_schedule_t*); void (drake_schedule_destroy_merge)(drake_schedule_t*); int (drake_task_number_merge)(); char* (drake_task_name_merge)(size_t); drake_platform_stream_create_explicit(stream, drake_schedule_init_merge, drake_schedule_destroy_merge, drake_function_merge);
