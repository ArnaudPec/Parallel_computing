...
# 34 "merge.c"
int
merge_init_task_10(task_t *task, void* aux)
{
 link_t *link;
 array_int_t *tmp;
...
int
merge_start_task_10(task_t *task)
{
 link_t *link;
 int j;
...
int
merge_kill_task_10(task_t *task)
{
...
int
merge_destroy_task_10(task_t *task)
{
