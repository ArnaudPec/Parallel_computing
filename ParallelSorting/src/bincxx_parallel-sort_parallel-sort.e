...
main(size_t argc, char **argv)
{
 ...
 array_int_t *array = pelib_array_int_loadfilenamebinary(argv[1]);
 cfifo_int_t *fifo = pelib_cfifo_int_from_array(array);
 ...
 sort(fifo->buffer, pelib_cfifo_int_length(fifo));
