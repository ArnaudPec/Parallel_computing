                                                            ...
                                                            echo >> $HOME/.cshrc
                                                              echo $shell_comment >> $HOME/.cshrc
                                                                echo 'if ($?'$shell_var') then' >> $HOME/.cshrc
                                                                  echo 'echosetenv' $shell_var '${'"$shell_var}:$lib" >> $HOME/.cshrc
                                                                    echo 'else' >> $HOME/.cshrc
                                                                    echo 'echosetenv' "$shell_var $lib" >> $HOME/.cshrc
                                                                  ...
                                                                  ## Install ggplot
                                                                  R -e 'install.packages("ggplot2", dependencies = TRUE, repos = "http://ftp.sunet.se/pub/lang/CRAN/", lib = "'$lib'")'
